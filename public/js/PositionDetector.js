(function(){
    ...
    //detect a postion where both arms are up
        function detectTpos(handLeftJointPoint, handRightJointPoint, shoulderLeftJointPoint, shoulderRightJointPoint, elbowLeftJointPoint, elbowRightJointPoint) {
            ...
            if (Math.abs(relativeShoulders) < 0.1) {
                if ((Math.abs(relativeElbowRightY) < 0.1) && (Math.abs(relativeElbowLeftY) < 0.1) && (Math.abs(relativeHandRightY) < 0.1) && (Math.abs(relativeHandLeftY) < 0.1) && (Math.abs(relativeElbowRightX) > 0.1) && (Math.abs(relativeElbowLeftX) > 0.1) && (Math.abs(relativeHandRightX) > 0.1) && (Math.abs(relativeHandLeftX) > 0.1)) {
        ...
        //detect a postion where right arm is up, left arm is down
        function detectHRpos(handLeftJointPoint, handRightJointPoint, shoulderLeftJointPoint, shoulderRightJointPoint, elbowLeftJointPoint, elbowRightJointPoint, spineBaseJointPoint) {
            var handLeftX = handLeftJointPoint.depthX;
            var handLeftY = handLeftJointPoint.depthY;
            ...
            //console.log(relativeHandRightY);
            if (Math.abs(relativeShoulders) < 0.1) {
                if ((Math.abs(relativeElbowRightY) < 0.1) && (Math.abs(relativeElbowRightX) > 0.1) && (Math.abs(relativeHandRightY) < 0.1) && (Math.abs(relativeHandRightX) > 0.1) && (Math.abs(relativeHandToSpine) < 0.05) && (Math.abs(relativeElbowLeftX) < 0.1) && (Math.abs(relativeHandLeftX) < 0.1) ) {
                    //console.log("T pos detected !!");
                    // draw semi transparent hand cicles
        ...
        //detect a postion where left arm is up, rigth arm is down
        function detectHLpos(handLeftJointPoint, handRightJointPoint, shoulderLeftJointPoint, shoulderRightJointPoint, elbowLeftJointPoint, elbowRightJointPoint, spineBaseJointPoint) {
            var handLeftX = handLeftJointPoint.depthX;
            var handLeftY = handLeftJointPoint.depthY;
            ...
            //console.log(relativeHandRightY);
            if (Math.abs(relativeShoulders) < 0.1) {
                if ((Math.abs(relativeElbowLeftY) < 0.1) && (Math.abs(relativeElbowLeftX) > 0.1) && (Math.abs(relativeHandLeftY) < 0.1) && (Math.abs(relativeHandLeftX) > 0.1) && (Math.abs(relativeHandToSpine) < 0.05) && (Math.abs(relativeElbowRightX) < 0.1) && (Math.abs(relativeHandRightX) < 0.1) ) {
                    //console.log("T pos detected !!");
                    // draw semi transparent hand cicles
